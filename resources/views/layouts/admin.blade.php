...
<body class="sidebar-mini layout-fixed layout-rtl" style="height: auto;">
    ...
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> {{ trans('cruds.allRightsReserved') }}
        </footer>
    ...
    <!-- Bootstrap 4 (لو حابب تثبت Bootstrap 5 استبدل الرابط) -->
