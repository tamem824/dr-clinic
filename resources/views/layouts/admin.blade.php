...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetime-picker/2.4.4/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed {{ app()->getLocale() == 'ar' ? 'layout-rtl' : '' }}" style="height: auto;">
<div class="wrapper">

    <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
        <ul class="container-fluid d-flex justify-content-start">
            <li class="nav-item">
...
<footer class="main-footer w-100 py-3 bg-dark text-white" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size: 14px; border-top: 2px solid #0dcaf0; box-shadow: 0 -2px 5px rgba(0,0,0,0.3);">
    <div class="text-center mx-auto">
        <strong>&copy;</strong> {{ trans('cruds.allRightsReserved')  }} {{trans('global.by')}}
        <a href="https://t-coda.com" target="_blank" rel="noopener noreferrer" class="text-info text-decoration-none">
            CODA
        </a>
    </div>
</footer>
...
<!-- Popper.js -->
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-+BmEe+LbWL7Xz2W33sQIGj3yJmPEV1A/rcxa9H6m0zZ4czJY57KJkz7EYlBEW94g" crossorigin="anonymous"></script>

<!-- Bootstrap 5 JS -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-ENjdO4Dr2bkBIFxQpeo5Y9rFdA5G0C/c5YoQaI68NtAcpgF9QBtTOae0JHtMZf8h"
...
<script>
    $(function() {
        ...
        $.extend(true, $.fn.dataTable.defaults, {
            language: {
                url: languages['{{ app()->getLocale() }}'] || languages['en']
            },
            columnDefs: [{
                orderable: false,
