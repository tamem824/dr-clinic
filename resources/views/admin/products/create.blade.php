...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="made_date">{{ trans('cruds.product.fields.made_date') }}</label>
                <input class="form-control datetime {{ $errors->has('made_date') ? 'is-invalid' : '' }}" type="text" name="made_date" id="made_date" value="{{ old('made_date') }}">
                @if($errors->has('made_date'))
                    <span class="text-danger">{{ $errors->first('made_date') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.made_date_helper') }}</span>
            </div>
            <div class="form-group">
